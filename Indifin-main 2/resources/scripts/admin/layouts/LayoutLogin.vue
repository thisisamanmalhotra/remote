...
const pageHeading = computed(() => {
  ...
  return 'Smart Invoicing for Indian Businesses , Build in Sweden'
})
...
const pageDescription = computed(() => {
  ...
  return 'Track your expenses, create invoices, generate beautiful reports & estimates. All in one place.'
})
...
const copyrightText = computed(() => {
  ...
  return 'Proxie Studio Pvt. Ltd. All Rights Reserved.'
})
